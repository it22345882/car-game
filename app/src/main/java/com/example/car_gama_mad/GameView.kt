...
class GameView(c: Context, private val gameTask: GameTask) : View(c) {
    private var myPaint: Paint? = null
    private var speed = 1
    private var time = 0
    private var score = 0
    private var myCarPosition = 0
    private val GAME_DELAY: Long = 40 // 25 frames per second
    ...
    init {
        myPaint = Paint()
        viewWidth = c.resources.displayMetrics.widthPixels
        viewHeight = c.resources.displayMetrics.heightPixels
    }
    ...
    fun start() {
        ...
        // Start the game loop
        postInvalidateDelayed(GAME_DELAY)
    }
}